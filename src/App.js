    ...
    return (
      ...
      />
          <Routes>
            ...
            <Route exact path="/technologies" element={<News setProgress={setProgress}  apiKey={apiKey} key="technology" pageSize={pageSize} country="in" category="technology"/>}></Route>
